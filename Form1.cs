...
namespace LAB1_TP
{
    ...
    {
        const double MAXpositive = 1000000;
        const double MINnegative = -1000000;
        //Fields
        Double result = 0;
        ...
        //Метод для вывода истории оперций между числами
        ...
        //Метод для удаления последнего введённого числа
        ...
        public void BtnOperation_Click(object sender, EventArgs e)
        {
            ...
            switch (operation)
            {
                ...
                case "sin(x)":
                    ...
                    TextDisplay1.Text = Convert.ToString(Math.Sin(Double.Parse(TextDisplay1.Text)));
                    break;
                case "%":
                    TextDisplay2.Text = $"%({TextDisplay1.Text})";
